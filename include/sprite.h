...
struct staticSprite2D
{
    ...
    static void testBuildingTextureAtlasWithoutUsingGenerationPackingAlgorithmUsingTestPNGs();
    // This will override the original texture atlas generated by testBuildingTextureAtlasWithoutUsingGenerationPackingAlgorithmUsingTestPNGs.
    static void testCreatingTextureAtlasWithGenerationPackingAlgorithmAndBuildingAlgorithmUsingTestPNGsUseAfterConfirmingBuildTextureAtlasWorks();
};
